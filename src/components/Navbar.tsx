        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <div className="flex items-center space-x-4">
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#E1306C] transition-colors duration-200">
              ...
              <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#FF0000] transition-colors duration-200">
